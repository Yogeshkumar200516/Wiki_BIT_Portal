...
function Navbar({ role, isDrawerOpen, setDrawerOpen, isDrawerHidden, setDrawerHidden }) {
...
React.useEffect(() => {
  ...
  const roleMenuItems = menuOptions[role]; // Get the menu options based on the user's role
...
<Drawer variant="permanent" open={isDrawerOpen} hidden={isDrawerHidden}>
  {/* Drawer Header */}
  <DrawerHeader>
    <Typography 
      variant="h6" 
